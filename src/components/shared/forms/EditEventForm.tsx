...
export const EditEventForm: FC<Props> = ({ eventId }) => {
        ...
        <div className="flex flex-wrap mx-3 mb-6">
          ...
          <div className="mb-3 w-full md:w-1/1 px-3 mt-2">
            <Select
              ...
              defaultValue={users.find(user => user.id === currentEvent.teacher) ? { value: currentEvent.teacher, label: users.find(user => user.id === currentEvent.teacher)?.name } : ''  }
              placeholder="Teacher"
              // isMulti
              // eslint-disable-next-line @typescript-eslint/no-explicit-any
