...
export const SignInPage = () => {
  ...
  // const loginGoogle = useAuthStore(state => state.loginUser)
  ...
  return (
    <>
      ...
      <div className="mt-10 px-6 sm:px-0 max-w-sm" onClick={()=>console.log('Aqui va el metodo de google login popup')}>
